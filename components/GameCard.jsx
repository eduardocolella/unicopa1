...
export default function GameCard({game}){
    ...
    const flags ={
        MEX: require('../assests/jogos/mexico.png'),
        RSA: require('../assests/jogos/south africa.png'),
        KOR: require('../assests/jogos/south korea.png'),
        CZE: require('../assests/jogos/czech republic.png'),
}
